...
void npuSvmInit(void)
    ...
    */
    ...
    if (npuSvmLog == NULL)
        {
        logDtError(LogErrorLocation, "svmlog.txt - aborting\n");
        exit(1);
        }
#endif
    }
