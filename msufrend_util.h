 ...
 */
#ifndef MSUFREND_UTIL_H
#define MSUFREND_UTIL_H
...
typedef struct struct_frend_int
    {
    bool            sfi_bSendReplyToCyber; /* TRUE if Cyber waits for reply from each interrupt to frend2. */
    TypFrendState   FrendState;
    TypCyberToFrend cf;
    } TypFrendInterface;

/* Name of mapping used for memory shared between FREND and DtCyber. */
#define MAP_FREND_INT           "FRENDSHM"
