...
- **nos1.job** : An example of a job that may be submitted to EI200 on CDC
NOS 1. You might need to change the username and/or password on the USER
statement before it will run successfully on your NOS 1 system. However, the
username and password specified in this example match the default values
used in the NOS 1.3 `install-from-scratch` system of the [NOS1.3](../../NOS1.3)
...
- **nos2.job** : An example of a job that may be submitted to RBF on CDC
NOS 2. You might need to change the username and/or password on the USER
statement before it will run successfully on your NOS 2 system. However, the
username and password specified in this example match the default values
