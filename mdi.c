...
static char *mdiHipFunc2String(PpWord funcCode)
    ...
    switch(funcCode)
        {
    case FcMdiMasterClear        : return "FcMdiMasterClear";
    case FcMdiReqGeneralStatus   : return "FcMdiReqGeneralStatus";
    case FcMdiWriteData          : return "FcMdiWriteData";
    case FcMdiReadData           : return "FcMdiReadData";
    case FcMdiReqDetailedStatus  : return "FcMdiReqDetailedStatus";
    case FcMdiReadError          : return "FcMdiReadError";
    case FcMdiStartReg           : return "FcMdiStartReg";
    case FcMdiStopReg            : return "FcMdiStopReg";
    case FcMdiReqDiagnostics     : return "FcMdiReqDiagnostics";
    case FcMdiSetProtoVersion    : return "FcMdiSetProtoVersion";
    case FcMdiDiagEchoTimeout    : return "FcMdiDiagEchoTimeout";
    case FcMdiDiagReadError      : return "FcMdiDiagReadError";
    case FcMdiNormalOperation    : return "FcMdiNormalOperation";
    case FcMdiNormalFlowCtrlOn   : return "FcMdiNormalFlowCtrlOn";
    case FcMdiNormalFlowCtrlOff  : return "FcMdiNormalFlowCtrlOff";
    case FcMdiReqProtoVersion    : return "FcMdiReqProtoVersion";
        }
#endif
    if (funcCode >= FcMdiReqProtoVersion && funcCode <= FcMdiReqProtoVersion + 0177)
        {
...
static char *mdiPfc2String(u8 pfc)
    ...
    switch (pfc)
        {
    case 0x01: return "Logical Link Regulation";
    case 0x02: return "Initiate Connection";
    case 0x03: return "Terminate Connection";
    case 0x04: return "Change Terminal Characteristics";
    case 0x0A: return "Initialize NPU";
    case 0x0E: return "Initiate Supervision";
    case 0x0F: return "Configure Terminal";
    case 0x10: return "Enable Command(s)";
    case 0x11: return "Disable Command(s)";
    case 0x12: return "Request NPU Status";
    case 0x13: return "Request Logical Link Status";
    case 0x14: return "Request Line Status";
    case 0x15: return "Request Terminal Status";
    case 0x16: return "Request Trunk Status";
    case 0x17: return "Request Coupler Status";
    case 0x18: return "Request Svc Status";
    case 0x19: return "Unsolicited Status";
    case 0x1A: return "Statistics";
    case 0x1B: return "Message(s)";
    case 0x1C: return "Error Log Entry";
    case 0x1D: return "Operator Alarm";
    case 0x1E: return "Reload NPU";
    case 0x1F: return "Count(s)";
    case 0x20: return "Online Diagnostics";
    default:
        sprintf(buf, "<%02X>", pfc);
        return(buf);
        }
...
static char *mdiSfc2String(u8 sfc)
    ...
    switch (sfc)
        {
    case 0x00: return "NPU";
    case 0x01: return "Logical Link";
    case 0x02: return "Line";
    case 0x03: return "Terminal";
    case 0x04: return "Trunk";
    case 0x05: return "Coupler";
    case 0x06: return "Switched Virtual Circuit";
    case 0x07: return "Operator";
    case 0x08: return "Terminate Connection";
    case 0x09: return "Outbound A-A Connection";
    case 0x0A: return "Initiate Supervision";
    case 0x0B: return "Dump Option";
    case 0x0C: return "Program Block";
    case 0x0D: return "Data";
    case 0x0E: return "Terminate Diagnostics";
    case 0x0F: return "Go";
    case 0x10: return "Error(s)";
    case 0x11: return "A-A Connection";
    case 0x12: return "PB Perform STI";
    case 0x13: return "NIP Block Protocol Error";
    case 0x14: return "PIP Block Protocol Error";
    default:
        sprintf(buf, "<%02X>", sfc);
        return(buf);
        }
