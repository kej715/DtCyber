...
[sudo] node install [basic | full | (readytorun | rtr) [<image name>]][(continue | cont)]
  ...
  readytorun : (alias rtr) install a ready-to-run system image
               <image name> is one of:
                 ...
                 dual-state-860        : full NOS 2.8.7 system running on a Cyber 860
...
| dual-state-860 | This image includes all available programming languages and other features of NOS 2.8.7, it runs on a **Cyber 860** mainframe with 128 Mbytes of central memory, and it also runs NOS/VE 1.8.3 in dual-state mode. |
